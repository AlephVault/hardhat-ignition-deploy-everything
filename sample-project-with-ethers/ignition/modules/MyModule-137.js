...
module.exports = buildModule("MyModule2", (m) => {
  ...
  // This is a simple module which only refers a contract. The result
  // of m.contractAt is a special value (not an actual contract nor its
  ...
  const contract = m.contractAt(
    "MyContract", "0xBe044425877b1a7ADd6794aC4fbDfE057ec0bcA6"
  );
