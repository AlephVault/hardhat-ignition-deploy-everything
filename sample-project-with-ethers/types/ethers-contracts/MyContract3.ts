...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "./common.js"
  ...
  export interface MyContract3Interface extends Interface {
  ...
  export interface MyContract3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): MyContract3;
    waitForDeployment(): Promise<this>;

    interface: MyContract3Interface;
