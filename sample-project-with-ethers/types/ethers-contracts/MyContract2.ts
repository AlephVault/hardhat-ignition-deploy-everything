...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "./common.js"
  ...
  export interface MyContract2Interface extends Interface {
  ...
  export interface MyContract2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): MyContract2;
